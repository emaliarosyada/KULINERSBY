...
$produk = query("SELECT * FROM khas WHERE namarestoran = 'Sate klopo Ondomohen'");
$review = query("SELECT * FROM review3");
...
if(isset($_POST["submit"]) ){
  ...
  if(tambahreview($_POST) > 0) {
      ...
      <script>
          ...
          document.location.href = 'restoran3.php';
      </script>
      ";
      header('location: restoran3.php');
  } else {
      echo "
      <script>
                        ...
                        <div id="demo" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                              <div class="carousel-item active">
                                <img src="img/sateklopo.jpg" alt="Los Angeles" width="1100" height="500">
                              </div>
                              <div class="carousel-item">
                                <img src="img/sateklopo2.jpg" alt="Chicago" width="1100" height="500">
                              </div>
                              <div class="carousel-item">
                                <img src="img/sateklopo1.jpg" alt="New York" width="1100" height="500">
                              </div>
                            </div>
                        ...
                        <div id="menu" class="w3-modal">
                            <div class="w3-modal-content w3-animate-zoom">
                                ...
                                <div class="w3-container">
                                    <h5>Soto Klopo daging sapi <b>Rp. 28.000</b></h5>
                                    <h5>Soto Klopo daging  ayam <b>Rp. 20.000</b></h5>
                                </div>
