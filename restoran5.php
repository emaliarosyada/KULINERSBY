...
$produk = query("SELECT * FROM khas WHERE namarestoran = 'Bebek Palupi'");
$review = query("SELECT * FROM review5");
...
if(isset($_POST["submit"]) ){
  ...
  if(tambahreview($_POST) > 0) {
      ...
      <script>
          ...
          document.location.href = 'restoran5.php';
      </script>
      ";
      header('location: restoran5.php');
  } else {
      echo "
      <script>
                        ...
                        <div id="demo" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                              <div class="carousel-item active">
                                <img src="img/bebek.jpg" alt="Los Angeles" width="1100" height="500">
                              </div>
                              <div class="carousel-item">
                                <img src="img/bebek palupi1.jpg" alt="Chicago" width="1100" height="500">
                              </div>
                              <div class="carousel-item">
                                <img src="img/bebekpalupi2.jpg" alt="New York" width="1100" height="500">
                              </div>
                            </div>
                        ...
                        <div id="menu" class="w3-modal">
                            <div class="w3-modal-content w3-animate-zoom">
                                ...
                                <div class="w3-container">
                                    <h5>Bebek goreng paha <b>Rp. 20.000</b></h5>
                                    <h5>Bebek goreng dada <b>Rp. 20.000</b></h5>
                                    <h5>Ayam goreng dada <b>Rp. 13.000</b></h5>
                                    <h5>Ayam goreng paha <b>Rp. 10.000</b></h5>
                                    <h5>Nasi <b>Rp. 4.000</b></h5>
                                </div>
