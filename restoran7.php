...
$produk = query("SELECT * FROM khas WHERE namarestoran = 'Sego Sambel Mak Yeye'");
$review = query("SELECT * FROM review6");
                        ...
                        <div id="demo" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                              <div class="carousel-item active">
                                <img src="img/about1.jpg" alt="Los Angeles" width="1100" height="500">
                              </div>
                              <div class="carousel-item active">
                                <img src="img/about1.jpg" alt="Los Angeles" width="1100" height="500">
                              </div>
                        ...
                        <div id="menu" class="w3-modal">
                            <div class="w3-modal-content w3-animate-zoom">
                                ...
                                <div class="w3-container">
                                    <h5>Sego sambel ayam <b>Rp. 18.000</b></h5>
                                    <h5>Sego sambel pe <b>Rp. 15.000</b></h5>
                                    <h5>Sego sambel telur <b>Rp. 15.000</b></h5>
                                </div>
