...
$produk = query("SELECT * FROM khas WHERE namarestoran = 'Tahu Tek Pak Jayen'");
$review = query("SELECT * FROM review1");
...
if(isset($_POST["submit"]) ){
  ...
  if(tambahreview($_POST) > 0) {
      ...
      <script>
          ...
          document.location.href = 'restoran6.php';
      </script>
      ";
      header('location: restoran6.php');
  } else {
      echo "
      <script>
                        ...
                        <div id="demo" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                              <div class="carousel-item active">
                                <img src="img/jayen1.jpg" alt="Los Angeles" width="1100" height="500">
                              </div>
                              <div class="carousel-item">
                                <img src="img/jayen2.jpg" alt="Chicago" width="1100" height="500">
                              </div>
                              <div class="carousel-item">
                                <img src="img/jayen1.jpg" alt="New York" width="1100" height="500">
                              </div>
                            </div>
                        ...
                        <div id="menu" class="w3-modal">
                            <div class="w3-modal-content w3-animate-zoom">
                                ...
                                <div class="w3-container">
                                    <h5>Tahu telur <b>Rp. 15.000</b></h5>
                                    <h5>TaHU tek <b>Rp. 12.000</b></h5>
                                </div>
