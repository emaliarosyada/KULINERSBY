...
<!----------About Section-------->
    ...
    <div class="container text-center">
        ...
        <div class="row text-center">
            <div class="col-md-4">
            <a href="restoran7.php"> <img src="img/about1.jpg" class="about-img">
            ...
            <div class="col-md-4">
            <a href="restoran8.php"> <img src="img/about2.jpg" class="about-img">
            ...
            <div class="col-md-4">
            <a href="restoran6.php"><img src="img/about3.jpg" class="about-img">
        ...
        <div class="container">
            <div class="row">
                ...
                <p><b>EMAIL NEWSLETTER</b></p>
                    ...
                    <button type="button" class="btn btn-primay">Kirim</button>
                </div>
            </div>
            <hr>
            <p class="copyright">Website Crafted by Kuliner Surabaya</p>
        </div>
</section>
