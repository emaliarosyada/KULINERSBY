...
$review = query("SELECT * FROM review2");
...
if(isset($_POST["submit"]) ){
  ...
  if(tambahreview($_POST) > 0) {
      ...
      <script>
          ...
          document.location.href = 'restoran2.php';
      </script>
      ";
      header('location: restoran2.php');
  } else {
      echo "
      <script>
                        ...
                        <div id="demo" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                              <div class="carousel-item active">
                                <img src="img/gendut1.jpg" alt="Los Angeles" width="1100" height="500">
                              </div>
                              <div class="carousel-item">
                                <img src="img/gendut2.jpg" alt="Chicago" width="1100" height="500">
                              </div>
                        ...
                        <div id="menu" class="w3-modal">
                            <div class="w3-modal-content w3-animate-zoom">
                                ...
                                <div class="w3-container">
                                    <h5>Lontong Balap <b>Rp. 10.000</b></h5>
                                    <h5>Sate kerang <b>Rp. 3.000</b></h5>
                                </div>
